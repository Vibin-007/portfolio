...
export default function Projects() {
    ...
    return (
        <section id="projects" className="pt-24 md:pt-16 pb-24 px-6 relative scroll-mt-16 md:scroll-mt-8">
                            ...
                            <div className={`flex flex-col bg-white border-4 border-ink p-8 h-full shadow-hard-lg transition-transform duration-300 ${i % 2 === 0 ? 'border-wobbly rotate-1 group-hover:rotate-0' : 'border-wobbly-md group-hover:translate-y-[-5px]'}`}>
                                ...
                                {p.repoLink && (
                                    <a
                                        ...
                                        className="mt-6 inline-flex items-center gap-2 px-5 py-2.5 border-2 border-ink bg-ink text-white font-bold font-body text-sm shadow-hard-sm hover:-translate-y-1 hover:bg-accent hover:border-accent transition-all duration-200 self-start cursor-none"
                                    >
